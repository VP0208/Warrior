...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWaitSpawnEnemiesDelegete, const TArray<AWarriorEnemyCharacter*>&, SpawnedEnemies);
/**
 * 
 */
UCLASS()
...
public:
	...
	FWaitSpawnEnemiesDelegete OnSpawnFinished;

	UPROPERTY(BlueprintAssignable)
	FWaitSpawnEnemiesDelegete DidNotSpawn;
...
private:
	...
	TSoftClassPtr<AWarriorEnemyCharacter> CachedSoftClassToSpawn;
