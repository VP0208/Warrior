...
void UWarriorGameInstance::OnDestinationWorldLoaded(UWorld*)
{
...
{
	for (const FWarriorGameLevelSet& GameLevels : GameLevelSets)
	{
		if (!GameLevels.IsValid()) continue;

		if (GameLevels.LevelTag == InTag)
		{
