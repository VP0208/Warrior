                                                                               ...
                                                                               const FVector& SpawnOrigin, float RandomSpawnRadius)
{
	...
	Node->CachedSoftClassToSpawn = SoftEnemyClassToSpawn;
...
{
	if (ensure(!CachedSoftClassToSpawn.IsNull()))
	{
		UAssetManager::Get().GetStreamableManager().RequestAsyncLoad(
		CachedSoftClassToSpawn.ToSoftObjectPath(),
...
{
	UClass* LoadedClass = CachedSoftClassToSpawn.Get();
